# SYSTEM_PROMPT = """You are playing Super Mario Land. You see the game screen and can control the game only by issuing emulator commands.

# Your goal is to progress through levels, collect coins and power-ups when safe, and ultimately finish the game by rescuing Princess Daisy.
...
The goal is to progress through levels (to the rightmost side of the screen), collect coins and power-ups when safe, and ultimately finish the game by rescuing Princess Daisy. The rightmost side of the screen is the goal.
...
2. Each button should be one of: 'a', 'b', 'up', 'down', 'left', 'right'
...
OLD_SYSTEM_PROMPT = """You are playing Super Mario Land.
